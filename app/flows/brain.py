...
RETURN_PHRASES: dict[str, str] = {
    ...
    "BOOK_NAME":         "So, coming back to your booking — who am I booking in today?",
    ...
    "RESCH_NAME":        "So, coming back to your reschedule — what's your name so I can find your booking?",
