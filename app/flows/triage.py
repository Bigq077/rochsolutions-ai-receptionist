...
async def triage_turn(
    ...
    if state == INS_EXPLAIN:
        # They've heard the explanation — ask for insurer
        gather_insurer = (
        ...
        # If they have questions, answer them first
    ...
    if state == INS_BUPA_RESPONSE:
        if is_yes(user_said) or "still" in user_said.lower() or "book" in user_said.lower():
            ...
            session["state"] = TRIAGE
            return _say(
                "Wonderful. Not a problem at all. "
        ...
        if is_no(user_said) or "think" in user_said.lower():
            ...
            return _say(
                ...
                "If you'd like, I can take your name and number "
                "and have someone from the team call you back. "
                "Would that be helpful?",
                session, tone="none",
            )
        return _say(
            "Would you still like to go ahead and book privately, "
            "or would you prefer some time to think it over?",
            session, tone="checking",
        )
