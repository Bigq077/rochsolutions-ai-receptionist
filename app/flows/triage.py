...
def parse_patient_type(text: str | None) -> Optional[str]:
    ...
    Deterministic and robust to ASR variations.
    """
    if not text:
        return None
    ...
    # Heuristic: "follow" almost always implies returning
