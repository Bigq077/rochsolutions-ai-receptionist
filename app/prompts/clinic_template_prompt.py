...
def _spine(clinic: Dict[str, Any], tk: Dict[str, str], dc: Dict[str, str]) -> Dict[str, str]:
    ...
    booking_flow = (
        ...
        "8. PHONE. First offer the calling number as TWO clean sentences, with "
    ...
    reschedule_cancel = (
        ...
        "lookup_patient call.\n"
        "  - If the caller confirms it IS the number their booking is under and "
        "you still cannot find it → ONLY THEN say exactly: 'I'm not able to "
        "find an appointment under your details — let me put you through to the "
        "team.' and transfer.\n"
