...
def _spine(clinic: Dict[str, Any], tk: Dict[str, str], dc: Dict[str, str]) -> Dict[str, str]:
    ...
    reschedule_cancel = (
        ...
        "say \"use this number\" — otherwise, tell me the number you booked "
        "under.'\n"
        ...
        "Caller confirms the appointment is theirs → CHOOSE ACTION: ALWAYS ask "
        "exactly 'Would you like to cancel this appointment altogether, or "
        "would you like to reschedule it to a different time?' Ask this every "
        "time — even if the caller mentioned cancel or reschedule earlier in "
        "the call, let them choose now. Wait for their answer, then follow the "
