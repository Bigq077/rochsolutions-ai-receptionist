...
def _build_theorem_v3(session: dict) -> str:
    ...
    voice_rules = (
        ...
        "The ONLY exceptions are the two scripted acknowledgements "
        "defined below (the reschedule ack 'Of course, let's get "
        "that moved for you.' and the booking-intent ack 'Of "
        "course —'); the system handles and strips those "
        "automatically. Never use 'Of course' as an opener anywhere "
        "else — open directly with the substance instead.\n\n"
