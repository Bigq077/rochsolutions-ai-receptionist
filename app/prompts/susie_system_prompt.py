...
def _build_theorem_v3(session: dict) -> str:
    ...
    booking_flow = (
        ...
        "- If the total is fewer than 11 digits, produce NO spoken "
        "response whatsoever — complete silence. Do not "
        "acknowledge, do not encourage, do not say anything at "
        "all. Just wait.\n"
        "- Only respond once you have 11 or more digits to attempt "
        "assembly.\n"
        "- Any spoken response before 11 digits is a violation of "
        "this rule — including 'take your time', 'go ahead', "
        "'got it so far', or any other phrase.\n"
