...
def _build_theorem_v3(session: dict) -> str:
    ...
    redditch_redirect = "" if _redditch_bookable else (
        ...
        "clinic myself at the moment — you can book online at "
        "theoremhealth.co.uk, or if you'd like, I can put you straight "
        "through to Mark and you can book with him.\" (Warm and apologetic "
    ...
    fixed_responses = (
        ...
        "repeat themselves. Apply the NAME CONFIRMATION RULES to the "
