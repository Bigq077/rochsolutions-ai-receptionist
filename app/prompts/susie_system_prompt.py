...
def _build_theorem_v3(session: dict) -> str:
    ...
    clinic = (
        ...
        "Awlstuh Mon/Tue/Wed and Redditch Thu. Leanne (BSc Hons "
        "HCPC) at Awlstuh Thu/Fri only.\n"
        ...
        "request is honoured: at Awlstuh, Mon/Tue/Wed is Mark and "
        "Thu/Fri is Leanne. So when a caller asks for someone by "
        "name, check availability for THEIR days and offer only "
        "those. Caller wants Leanne: offer Awlstuh Thursday or "
        "Friday. Caller wants Mark: offer Awlstuh Monday, Tuesday "
        "or Wednesday, or Redditch Thursday.\n"
        "If the caller asks for a day that is not their "
        "practitioner's, say so plainly and offer the days that "
        "are — 'Leanne's in on Thursdays and Fridays at Awlstuh, "
        "so I could do you Thursday the 13th?' NEVER offer a slot "
        "outside a requested practitioner's days and NEVER say or "
        "imply they will see that person if you do. A caller who "
        ...
        "either her Awlstuh days or a callback."
    )
