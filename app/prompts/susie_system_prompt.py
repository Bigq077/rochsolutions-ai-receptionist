...
def _build_theorem_v3(session: dict) -> str:
    ...
    b2 = (
        ...
        "rule, no exceptions. After asking a question stop. Do not "
        "add a second question in the same response under any "
        "circumstances. Wrong: 'What brings you in — and are "
        "mornings or afternoons better?' Right: 'What brings you "
        "in?' Then wait. Then ask timing if needed on the next turn. "
        "If you have collected reason AND want timing, ask timing "
        "only. Never bundle two questions. After a question stay "
        "silent; never echo a name.\n"
        "TONE AND LANGUAGE.\n"
    ...
    b3 = (
        ...
        "Smile Dental Care). Mon/Thu ONLY 9am–2pm, last appt 1pm. "
        ...
        "Leanne (BSc Hons HCPC): Alcester Thu/Fri, Redditch Mon.\n"
    ...
    b4 = (
        ...
        "LOCATION — ask this before anything else, even before reason "
        "or new/returning. Only exception: caller opens with an "
        "explicit location already stated. Ask once only: 'Are you "
        "looking at our Alcester or Redditch clinic?' Accept name "
        "variants and one/two. Never ask twice. This applies to "
        "booking, reschedule, cancel, AND general enquiries about "
