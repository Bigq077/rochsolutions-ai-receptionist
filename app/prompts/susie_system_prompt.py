...
def _build_theorem_v3(session: dict) -> str:
    ...
    static = (
        ...
        "and what number shall I put down for you?'\n"
    ...
    booking_flow = (
        ...
        "Sarah — and what number shall I put down for you?'\n"
        "If the caller corrects their name, acknowledge and "
        "continue in the same turn: 'Sarah — got it. And what "
        "number shall I put down for you?'\n"
