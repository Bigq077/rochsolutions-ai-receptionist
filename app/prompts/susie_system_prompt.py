...
def _build_theorem_v3(session: dict) -> str:
    ...
    clinic = (
        ...
        "Practitioners. Mark Dyer at "
        "Awlstuh Mon/Tue/Wed/Fri and Redditch Thu. Leanne (BSc Hons "
        "HCPC) at Awlstuh THURSDAY EVENINGS ONLY.\n"
        "Prescribing: Mark is the ONLY prescriber. Leanne is NOT a "
        "prescriber — never say she prescribes, and never say 'both' "
        "or 'our physios' are prescribers. If a caller seeing Leanne "
        "asks about medication or pain relief, the answer is yes via "
        "Mark: after the assessment, Leanne can ask Mark to prescribe.\n"
