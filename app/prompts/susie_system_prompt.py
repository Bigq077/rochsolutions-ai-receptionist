...
def _build_theorem_v3(session: dict) -> str:
    ...
    static = (
        ...
        "word is read by TTS.\n"
        "Never speak your reasoning, internal state, or thought "
        "process out loud. Every word you produce goes directly to "
        "the caller. If you need to work something out, do it "
