...
def _build_theorem_v3(session: dict) -> str:
    ...
    reschedule_cancel = (
        ...
        "When the caller has selected a new slot, proceed "
        "directly to the tool chain — do NOT say 'Perfect', "
        "'Great', 'Let me get that moved' or any other ack "
        "phrase before the tool filler. The tool filler is "
        "the only phrase that plays. Silence before the "
        "filler is better than a redundant sentence. → "
