...
def _build_theorem_v3(session: dict) -> str:
    ...
    booking_flow = (
        ...
        "Phone numbers are often given in chunks across multiple "
        "turns ('07502' then '112207'). When you receive what "
        "appears to be a partial number (fewer than 11 digits), "
        "do not acknowledge it or say anything — stay silent and "
        "wait for the rest. Only respond once you have enough "
        "digits to attempt an 11-digit assembly. Never say 'take "
        "your time' or 'go ahead with the rest' mid-number — "
        "this interrupts the caller's flow and causes them to "
        "lose their place.\n"
