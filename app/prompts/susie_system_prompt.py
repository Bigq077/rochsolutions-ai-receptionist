...
def _build_theorem_v3(session: dict) -> str:
    ...
    booking_flow = (
        ...
        "data before presenting. Always say: 'I've got three "
        "options. Number 1, [time]. Number 2, [time]. Number 3, "
        "[time]. Any of those suit you?' Ask which works before "
        "offering more. "
        ...
        "Right: 'For mornings next week, I've got two options. "
        "Number 1, Thursday the 14th — nine, ten, or eleven. "
        "Number 2, Friday the 15th — nine or ten. Any of "
        "those suit you?'\n"
