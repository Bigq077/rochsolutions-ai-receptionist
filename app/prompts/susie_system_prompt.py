...
def _build_theorem_v3(session: dict) -> str:
    ...
    redditch_redirect = "" if _redditch_bookable else (
        ...
        "our Alcester clinic if that suits, or I can put you straight "
        ...
        "at Alcester instead, carry on and help them with that as normal.\n"
    ...
    #  3. The injected clinic question ("Alcester or Redditch?") asked something
    ...
    if _rc_cli:
        _rc_turn2_number = (
            ...
            "then ask a plain yes/no: \"Right, Alcester. I've got you on "
            ...
            "\"Right, Alcester.\" with no question leaves the caller in "
        ...
        _rc_turn2_number = (
            ...
            "Say EXACTLY: \"Right, Alcester. Could you type the number the "
            ...
            "Alcester.\" with no question leaves the caller in silence with "
    ...
    reschedule_cancel = (
        ...
        "Alcester, the booking says Redditch — the booking is right "
        ...
        "practitioner rota): an Alcester THURSDAY EVENING is Leanne, "
        "any other Alcester day is Mark. So if you are moving an "
        "Alcester Thursday-evening appointment to any other day, the "
        ...
        "original appointment at our Alcester or Redditch clinic?\"\n"
        "  Cancel → \"No problem at all. Was the appointment you'd "
        "like to cancel at our Alcester or Redditch clinic?\"\n"
        ...
        "value=\"alcester\") for Alcester, or value=\"redditch\" for "
    ...
    clinic = (
        ...
        "Alcester Mon/Tue/Wed/Fri and Redditch Thu. Leanne (BSc Hons "
        "HCPC) at Alcester THURSDAY EVENINGS ONLY.\n"
        ...
        "request is honoured: at Alcester, Mon/Tue/Wed/Fri is Mark "
        "and Thursday evening is Leanne. So when a caller asks for "
        "someone by name, check availability for THEIR days and "
        "offer only those. Caller wants Leanne: offer Alcester "
        "Thursday, evening slots. Caller wants Mark: offer Alcester "
        "Monday, Tuesday, Wednesday or Friday, or Redditch "
        "Thursday.\n"
        "Friday at Alcester is MARK, not Leanne. Never offer a "
        ...
        "are — 'Leanne's in on Thursday evenings at Alcester, so I "
        ...
        "either her Alcester Thursday evenings or a callback."
    )
    ...
    joint_injections = (
        ...
        "injections are something Mark does himself at our Alcester "
        ...
        "A service Mark offers at the Alcester clinic. Corticosteroid "
        ...
        "ALCESTER ONLY. Injections are not offered at Redditch. If a "
        "caller asks for an injection at Redditch, say injections run "
        "from the Alcester clinic.\n"
    ...
    faq = (
        ...
        "put them through to Mark, AND an offer to book at Alcester "
    ...
    _booking_step2 = (
        ...
        if (_loc_confirmed and _sel_loc)
            ...
            "Alcester or Redditch?\" Wait. Accept name variants "
    ...
    booking_flow = (
        ...
        "Alcester or Redditch?', (2) wait for the caller to confirm, "
        ...
        "asks 'Which clinic — Alcester or Redditch?' → caller says "
        ...
        "— Alcester or Redditch?' and wait for the answer. "
        ...
        "afternoon at Alcester — shall I go ahead and book that "
    ...
    treatment_override = (
        ...
        "our Alcester clinic — they're always given after an "
