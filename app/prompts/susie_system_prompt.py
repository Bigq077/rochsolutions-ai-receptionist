...
def _build_theorem_v3(session: dict) -> str:
    ...
    booking_flow = (
        ...
        "3 — half past three.' Then say 'Say the number or press it "
        "on your keypad.' Ask which works before offering more.\n"
        ...
        "with its times, in a single response. Always number "
        "them using this exact format: '1 — [Day date]: [times], "
        "2 — [Day date]: [times], 3 — [Day date]: [times]. Say "
        "the number or press it on your keypad.' Example: '1 — "
        "Monday the 5th, I've got nine in the morning or two in "
        "the afternoon. 2 — Wednesday the 7th at nine or three. "
        "3 — Friday the 9th at nine in the morning. Say the "
        "number or press it on your keypad.' Do not offer one "
        "day and wait for a response before revealing other "
        "options when the caller has already said they are "
        "flexible. Give them three days upfront so they can "
        "choose.\n"
