"""
app/utils — shared utility functions for the AI Receptionist.

E.164 phone validation helpers are defined here so they can be imported as:
    from app.utils import is_valid_e164, normalise_to_e164
"""
