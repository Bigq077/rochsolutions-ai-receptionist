...
CASES = [
    ...
    ("as soon as possible", "as soon as possible",
     ("single_day", "earliest"), ("multi_day", "soonest_first"),
     "ASAP — single_day+earliest on Acuity; multi_day+soonest_first here"),
    ("this week", "this week",
     ("multi_day", "soonest_first"), ("multi_day", "soonest_first"),
     "a soonest-ish preference that is NOT an Acuity ASAP signal — stage B "
     "option B reaches Theorem's multi_day readouts through this case"),
