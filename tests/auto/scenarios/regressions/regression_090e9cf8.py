...
SCENARIO = {'id': 'regression_090e9cf8',
 'phase': 'Regression — mined from real calls',
 'name': "Regression from regression_090e9cf8 (score 1, tags ['booking_error', 'loop', "
         "'wrong_info', 'hallucination', 'dead_end'])",
 ...
 'transcript': [{'role': 'assistant',
                ...
                {'role': 'assistant',
                 'text': "Sorry about that — could you say that again for me? I'm sorry to hear "
                         'that. Before we look at the next step, can I ask — do you have any '
                ...
                {'role': 'assistant',
                 'text': "That's reassuring to hear — thank you for clarifying. Back pain is "
                         'something Marcus sees a lot of, and the right assessment makes a real '
                         'difference in getting it settled properly.'},
                {'role': 'assistant',
                 'text': "Sorry about that — could you say that again? I'm sorry to hear that. "
                         'Before we look at the next step, can I ask — do you have any numbness '
 ...
 'source': {'clinic_id': 'jv_v1', 'call_sid_slug': 'regression_090e9cf8',
            'quality_score': 1,
            'failure_tags': ['booking_error', 'loop', 'wrong_info', 'hallucination', 'dead_end'],
            'rubric_version': 'v2'}}
