...
SCENARIO = {'id': 'regression_24e4947e',
 'phase': 'Regression — mined from real calls',
 'name': "Regression from regression_24e4947e (score 1, tags ['hallucination', 'wrong_info', "
         "'booking_error', 'loop', 'caller_frustration'])",
 ...
 'transcript': [{'role': 'assistant',
                ...
                {'role': 'assistant',
                 'text': "That's reassuring — good to hear. Back pain that's been bothering you "
                         'can really get in the way of day-to-day life. Would you like to book an '
                ...
                {'role': 'assistant',
                 'text': "I'm having trouble hearing you — you might be breaking up. Thanks [NAME] "
                         "— I've got you on oh seven three eight oh, eight four one, four six "
                         'eight — is that the best number for the booking?'},
 ...
 'source': {'clinic_id': 'jv_v1', 'call_sid_slug': 'regression_24e4947e',
            'quality_score': 1,
