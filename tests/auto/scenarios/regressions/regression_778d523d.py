...
SCENARIO = {'id': 'regression_778d523d',
 'phase': 'Regression — mined from real calls',
 'name': "Regression from regression_778d523d (score 1, tags ['hallucination', 'wrong_info', "
         "'booking_error', 'loop', 'dead_end', 'caller_frustration'])",
 ...
 'transcript': [{'role': 'assistant',
                ...
                {'role': 'assistant',
                 'text': "That's reassuring to hear. Back pain that's affecting your day-to-day "
                         ...
                         "assess what's going on and put together a plan for you. Would you like "
                ...
                {'role': 'assistant',
                 'text': "Sorry, I didn't quite catch that. Are you calling to book, reschedule, "
                         ...
                         'in?'}],
 'source': {'clinic_id': 'jv_v1', 'call_sid_slug': 'regression_778d523d',
            'quality_score': 1,
