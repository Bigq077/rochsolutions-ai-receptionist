...
SCENARIO = {'id': 'regression_b0e62908',
 'phase': 'Regression — mined from real calls',
 'name': "Regression from regression_b0e62908 (score 1, tags ['missed_escalation', 'wrong_info', "
         "'loop', 'booking_error'])",
 ...
 'transcript': [{'role': 'assistant',
                ...
                {'role': 'assistant',
                 'text': 'I think there may have been a bit of a mix-up — my last question was '
                         'about numbness or bladder and bowel changes alongside your back pain. '
                         'Just to check: do you have any numbness around the saddle area between '
                         'your legs, or any changes in your bladder or bowel control?'},
                {'role': 'user', 'text': 'Next week any morning'},
                {'role': 'assistant',
                 'text': "That's reassuring — good to know. Back pain that flares up and tightens "
                         "when you've been still usually settles really well with the right "
                         "guidance, and Marcus will assess what's driving it and put a plan "
                         'together.'},
                ...
                {'role': 'assistant',
                 'text': "Sorry, I didn't quite catch that. Are you calling to book, reschedule, "
                         ...
                         'in?'}],
 'source': {'clinic_id': 'jv_v1', 'call_sid_slug': 'regression_b0e62908',
            'quality_score': 1,
            'failure_tags': ['missed_escalation', 'wrong_info', 'loop', 'booking_error'],
            'rubric_version': 'v2'}}
