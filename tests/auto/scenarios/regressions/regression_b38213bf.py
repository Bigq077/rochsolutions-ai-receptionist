...
SCENARIO = {'id': 'regression_b38213bf',
 'phase': 'Regression — mined from real calls',
 'name': "Regression from regression_b38213bf (score 1, tags ['loop', 'wrong_info', "
         "'booking_error', 'dead_end', 'missed_escalation'])",
 ...
 'transcript': [{'role': 'assistant',
                ...
                {'role': 'assistant',
                 'text': "That's reassuring — good to know. Back pain that's been troubling you is "
                         'something Marcus sees a lot of success with. Would you like to book an '
                         'assessment so he can take a proper look?'},
                {'role': 'assistant',
                 'text': "Sorry, I didn't quite catch that. Are you calling to book, reschedule, "
                         'or cancel an appointment? Would you like to book an assessment so he can '
                         'take a proper look?'},
 ...
 'source': {'clinic_id': 'jv_v1', 'call_sid_slug': 'regression_b38213bf',
            'quality_score': 1,
            'failure_tags': ['loop',
                             'wrong_info',
                             'booking_error',
